...
// Watcher untuk validasi 'whatsapp'
            ...
            <div class="col-lg-8">
                            ...
                            <div class="floating-label-content">
                                <div class="floating-label-content">
                                    ...
                                    <input type="text" v-model="voucher" class="form-control games-input floating-input"
                                        name="voucher" id="voucher" placeholder="Masukkan kode" />
                                </div>
                ...
                <div v-if="elementInformation"
                    ...
                    <button type="button" id="btn-submit" @click="confirmOrder" class="btnYellowPrimary w-100 mt-2"
                        :disabled="loadingOrder" :class="{ 'is-loading': loadingOrder }">
                        <span v-if="loadingOrder" class="spinner-border spinner-border-sm" role="status"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ticketDetail page">
                                ...
                                <button type="button" @click="order" :disabled="loadingOrder"
